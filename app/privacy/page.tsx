...
export default function PrivacyPolicyPage() {
  ...
  const privacyContent = {
    ...
    introduction: `At ${siteConfig.name}, we take your privacy seriously. This Privacy Policy outlines how we collect, use, and protect your information when you use our services.`,
    sections: [
      {
          ...
          <article className="prose prose-xl lg:prose-2xl max-w-none rounded-[40px] bg-card p-8 shadow-custom md:p-12">
            ...
            {privacyContent.sections.map((section, index) => (
              <section key={index} className="mt-10">
                <h2 className="mb-3 font-poppins text-2xl font-medium text-foreground md:text-3xl">{section.title}</h2>
