  ...
  return (
    <>
      ...
      <section id="how-to-use" className="mx-auto max-w-7xl px-4 py-20">
        <h2 className="font-serif text-3xl font-semibold text-foreground md:text-5xl">How to Use {siteConfig.name}</h2>
      ...
      <section id="faq" className="mx-auto max-w-7xl px-4 py-20">
        <h2 className="font-serif text-3xl font-semibold text-foreground md:text-5xl">{siteConfig.name} Frequently Asked Questions</h2>
