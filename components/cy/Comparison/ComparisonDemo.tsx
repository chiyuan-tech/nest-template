...
import {
  comparisonDemoDataFieldDocSections,
  comparisonDemoFieldDocsLayoutPath,
  comparisonDemoFieldDocsTypesPath,
  type ComparisonDemoPreviewKey,
} from "@/components/cy/Comparison/ComparisonDemo.data";
import {
...
type PreviewKey = ComparisonDemoPreviewKey;
...
interface PreviewItem {
  ...
  usageCode: string;
  props: ComparisonTableCase1Data;
}

function renderComparisonDemoPreview(input: {
  item: PreviewItem;
...
const previewItems: PreviewItem[] = [
  {
    ...
    sourceFilePathForCopy: "@/components/cy/Comparison/comparison_table_case1.tsx",
    props: cyModulesConfig.ComparisonTableCase1 as ComparisonTableCase1Data,
    usageCode: [
      "import { ComparisonTableCase1 } from '@/components/cy/Comparison/comparison_table_case1';",
      "import cyModulesConfig from '@/components/cy/cy-modules.config.json';",
      "",
      "export default function Page() {",
      "  return <ComparisonTableCase1 data={cyModulesConfig.ComparisonTableCase1} />;",
      "}",
    ].join("\n"),
  },
];
...
const defaultTitleLayoutByKey: Record<PreviewKey, CyTitleLayoutId> = {
  ComparisonTableCase1: defaultCyTitleLayoutByModuleKey.ComparisonTableCase1,
};
        ...
        {previewItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              <CyDemoDataFieldDocs
                sections={comparisonDemoDataFieldDocSections[item.key]}
                typesPathLabel={comparisonDemoFieldDocsTypesPath}
                layoutPathLabel={comparisonDemoFieldDocsLayoutPath}
              />
              <div className="w-full min-h-0 flex-1 overflow-visible">
                {renderComparisonDemoPreview({
                  item,
        ...
        <DialogContent className="!top-0 !left-0 !h-screen !w-screen !max-w-none !translate-x-0 !translate-y-0 overflow-hidden rounded-none border-0 p-0 overflow-y-auto">
          {activeItem ? (
            <div className="flex h-full flex-col">
              ...
              <CyDemoDataFieldDocs
                sections={comparisonDemoDataFieldDocSections[activeItem.key]}
                className="px-5"
                typesPathLabel={comparisonDemoFieldDocsTypesPath}
                layoutPathLabel={comparisonDemoFieldDocsLayoutPath}
              />
