...
import {
  howToStepsDemoDataFieldDocSections,
  howToStepsDemoFieldDocsLayoutPath,
  howToStepsDemoFieldDocsTypesPath,
  type HowToStepsDemoPreviewKey,
} from "@/components/cy/HowToSteps/HowToStepsDemo.data";
import {
...
type PreviewKey = HowToStepsDemoPreviewKey;
...
interface PreviewItem {
  ...
  usageCode: string;
  props: HowToStepsCase1Data;
}

function renderHowToStepsDemoPreview(input: {
  item: PreviewItem;
...
const previewItems: PreviewItem[] = [
  {
    key: "HowToStepsCase1",
    title: "HowToStepsCase1",
    sourceFilePathForCopy: "@/components/cy/HowToSteps/how_to_steps_case1.tsx",
    props: cyModulesConfig.HowToStepsCase1 as HowToStepsCase1Data,
    usageCode: [
      "import { HowToStepsCase1 } from '@/components/cy/HowToSteps/how_to_steps_case1';",
      "import cyModulesConfig from '@/components/cy/cy-modules.config.json';",
      "",
      "export default function Page() {",
      "  return <HowToStepsCase1 data={cyModulesConfig.HowToStepsCase1} />;",
      "}",
    ].join("\n"),
  },
];
...
const defaultTitleLayoutByKey: Record<PreviewKey, CyTitleLayoutId> = {
  HowToStepsCase1: defaultCyTitleLayoutByModuleKey.HowToStepsCase1,
};

export function HowToStepsDemo() {
        ...
        {previewItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              <CyDemoDataFieldDocs
                sections={howToStepsDemoDataFieldDocSections[item.key]}
                typesPathLabel={howToStepsDemoFieldDocsTypesPath}
                layoutPathLabel={howToStepsDemoFieldDocsLayoutPath}
              />
              <div className="h-[82vh] overflow-hidden overflow-y-auto">
                {renderHowToStepsDemoPreview({
                  item,
        ...
        <DialogContent className="!top-0 !left-0 !h-screen !w-screen !max-w-none !translate-x-0 !translate-y-0 overflow-hidden rounded-none border-0 p-0 overflow-y-auto">
          {activeItem ? (
            <div className="flex h-full flex-col">
              ...
              <CyDemoDataFieldDocs
                sections={howToStepsDemoDataFieldDocSections[activeItem.key]}
                className="px-5"
                typesPathLabel={howToStepsDemoFieldDocsTypesPath}
                layoutPathLabel={howToStepsDemoFieldDocsLayoutPath}
              />
